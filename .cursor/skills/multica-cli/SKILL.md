...
In Filosage, invoke this optional skill only when Victor explicitly requests Multica work. Follow `AGENTS.md`; ordinary work does not require this CLI or its authentication.
