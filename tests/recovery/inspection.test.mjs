...
import { inspectRecoveryDatabase, recoveryOptions, recoveryHost, compareRecoverySnapshots } from '../../scripts/inspect-recovery-database.mjs';
...
test('only exact target hosts/databases with explicit verified TLS; URL overrides rejected', () => {
  ...
  assert.equal(options.host, recoveryHost); assert.equal(options.database, 'postgres');
