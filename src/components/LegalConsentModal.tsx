...
export default function LegalConsentModal() {
  ...
  return <div className="modal-layer legal-consent-layer">
    <section ref={dialogRef} tabIndex={-1} className="auth-dialog legal-consent-dialog" role="dialog" aria-modal="true" aria-labelledby="legal-consent-title">
      ...
      <p className="auth-copy">{isInitialSetup ? "Review the rules and data practices that apply before Erudoza creates your learning account." : "We updated the rules for using Erudoza or how account and learning data are handled."}</p>
