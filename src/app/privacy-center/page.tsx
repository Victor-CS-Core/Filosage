...
export default function PrivacyCenterPage() {
  ...
  const { user, isOwner, loading, signIn, reauthenticate, signOut } = useAuth();
        ...
        <section className="privacy-center-grid" aria-label="Privacy controls">
          ...
          <article>
            ...
            {user ? (
              ...
              <button className="button button-secondary" onClick={() => void signIn()}>Sign in to export</button>
            )}
          </article>
          ...
          <article className="privacy-danger-zone">
            ...
            {!user ? (
              <button className="button button-secondary" onClick={() => void signIn()}>Sign in to manage account</button>
            ) : isOwner ? (
