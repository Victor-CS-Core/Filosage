...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Turn a meaningful learning goal into a focused course, deliberate practice, useful review, and evidence you can inspect.",
    applicationName: "Filosage",
    category: "education",
    alternates: { canonical: origin },
    openGraph: {
      title: "Filosage — Turn curiosity into understanding",
      description: "Focused courses, visible lesson source status, deliberate practice, and evidence you can inspect for study, projects, career goals, and work.",
      type: "website",
      url: origin,
      siteName: "Filosage",
