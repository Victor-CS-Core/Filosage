...
Select exactly one relevant assigned source and exactly one of its atomic evidence claims. Write exactly one externally verifiable, non-hypothetical factual sentence, make that sentence a conservative complete entailment of the selected atomic claim, and return exactly one structured citation for that sentence. Do not repeat, combine, broaden, or paraphrase that factual sentence anywhere else in the lesson. Preserve the selected sourceId and evidenceClaimId exactly.
