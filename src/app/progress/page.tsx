  ...
  return (
    <AppShell>
      <div className="progress-page">
        <header className="page-header"><div><p className="overline">Learning record</p><h1>Your progress</h1><p>See what you have completed, what is due for review, and what to study next.</p></div></header>
        {!loaded ? <div className="dashboard-loading"><span /><span /><span /></div> : (
          <>
            <section className="progress-metrics" aria-label="Learning summary"><article><span><Flame size={21} /></span><div><small>Current streak</small><strong>{currentStreak(lessons)} {currentStreak(lessons) === 1 ? "day" : "days"}</strong><em>Study days in a row</em></div></article><article><span><Clock3 size={21} /></span><div><small>Tracked study time</small><strong>{Math.floor(minutes / 60)}h {minutes % 60}m</strong><em>Completed lessons</em></div></article><article><span><CheckCircle2 size={21} /></span><div><small>Concepts mastered</small><strong>{mastered}</strong><em>{lessons.length} lessons completed</em></div></article><article><span><Target size={21} /></span><div><small>First-try accuracy</small><strong>{accuracy ? `${accuracy}%` : "—"}</strong><em>Across retrieval checks</em></div></article></section>
