...
Avoid generic SaaS dashboards, template-like AI interfaces, decorative gradients, excessive cards, gratuitous glass effects, emoji-driven navigation, and visual choices that read as AI-generated slop. Do not imitate Notion literally or sacrifice learning clarity for novelty.

## Design Principles

1. Put the learning task before the interface.
2. Make public exploration effortless and private authoring unmistakably protected.
3. Reveal complexity progressively, keeping every screen calm and purposeful.
4. Use AI as a capable teaching partner, with clear state, control, and feedback.
5. Earn a premium feel through typography, spacing, motion, and reliability rather than decoration.

## Accessibility & Inclusion

Target WCAG 2.2 AA. Support complete keyboard navigation, visible focus, screen readers, strong contrast, reduced motion, touch targets, and color-independent success, warning, and error states.
