...
> Historical record from 2026-08-11 on the former Sites + Firebase host. Current production is Azure Container Apps + Easy Auth (Google) + Azure PostgreSQL. Details below describe the environment at the time of the evidence, not current production.
