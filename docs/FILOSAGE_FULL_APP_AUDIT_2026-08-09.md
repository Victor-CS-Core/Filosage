...
> Historical record from 2026-08-09. Current production is Azure Container Apps + Easy Auth (Google) + Azure PostgreSQL. Firestore details below describe the environment at the time of the audit, not current production.
