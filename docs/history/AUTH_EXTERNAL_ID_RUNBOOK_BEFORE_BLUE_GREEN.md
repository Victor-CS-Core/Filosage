> Historical External ID rollout plan. Superseded for current topology on September 6, 2026 by ../AUTH_EXTERNAL_ID_RUNBOOK.md. This is not an active deployment procedure.
