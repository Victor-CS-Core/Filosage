...
## September 13 deployed candidate follow-up

Source `0fcb5f502de1159c36c31785e4796b283c7b9a02` is deployed with image `sha256:dae13abacb841400d649ec892f4b6455e25e61a49547f937269417e65c8987af`. [Actual measurements](../research/artifacts/release-readiness-20260912/final-candidate-0fcb5f5-performance-20260913.json) supplement, rather than relabel, the historical local report.

A bounded read-only collection lookup executed in0.052ms (planning0.083ms). The runtime role had3sessions including the dedicated probe and0other active sessions at that instant. This is not a capacity or application-pool queue measurement. The real Flashcards generation completed; its unique attempt accounting estimate is$0.011021. The completed root and accounting-observed attempt mirror must not be summed: their combined$0.022042 is not spend. No other request status appeared in the selected08:00–08:30UTC window. This is an application estimate, not an invoice or uniquely identified user export.

Whole-app resource measurements08:23:56–08:34:16UTC include candidate and compatible predecessor: mean CPU0.009844core, maximum minute average0.166653core; mean working set326.36MiB, maximum minute average381.32MiB. The sample is small, may lag and is not request-weighted. Sampled public/rollback health checks stayed under190ms through08:34UTC. Keep existing scaling: these observations do not justify resizing or a paid warm-replica change.

Provider-only latency is absent from the stored receipt schema. A new public scale-from-zero benchmark and load test were not performed. These remain measurement limits; no fabricated timing, provider invoice, performance gain or capacity guarantee is claimed. Existing connection-budget and compatible-overlap controls remain in place.
